...
`}static get is(){return"shop-list-item"}static get properties(){return{item:Object}}_formatPrice(price){return price?"Q"+price.toFixed(2):""}}customElements.define(ShopListItem.is,ShopListItem);class ShopList extends _shopApp.PolymerElement{static get template(){return _shopApp.html`
