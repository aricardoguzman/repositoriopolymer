  ...
  <template>
    ...
    <div class="main-frame">
      <iron-pages id="pages" selected="[[state]]" attr-for-selected="state">
          ...
          <iron-form id="checkoutForm"
            ...
            <form method="post" action="data/sample_success_response.json" enctype="application/x-www-form-urlencoded">
              ...
              <div class="subsection grid" visible$="[[_hasItems]]">
                <section>
                  <h2 id="accountInfoHeading">Información de la cuenta</h2>
                  ...
                  <h2 id="shipAddressHeading">Dirección de envio</h2>
                  <div class="row input-row">
                    <shop-input>
                  ...
                  <div class="row input-row">
                    <shop-input>
                      ...
                      <shop-md-decorator error-message="Invalid State/Province" aria-hidden="true">
                        <label id="shipStateLabel">Departamento/Aldea</label>
                        <shop-underline></shop-underline>
                      </shop-md-decorator>
                    </shop-input>
                    <shop-input>
                  ...
                  <div class="billing-address-picker">
                    ...
                    <label for="setBilling">Usar otra dirección</label>
                  </div>
                  <div hidden$="[[!hasBillingAddress]]">
                    ...
                    <div class="row input-row">
                      <shop-input>
                        ...
                        <shop-md-decorator error-message="Invalid State/Province" aria-hidden="true">
                          <label id="billStateLabel">Departamento/Municipio</label>
                          <shop-underline></shop-underline>
                        </shop-md-decorator>
                      </shop-input>
                      <shop-input>
                ...
                <section>
                  ...
                  <div class="row input-row">
                    <shop-input>
                      ...
                      <shop-md-decorator error-message="Invalid Cardholder Name" aria-hidden="true">
                        <label for="ccName">Nombre propietario</label>
                        <shop-underline></shop-underline>
                      </shop-md-decorator>
                    </shop-input>
                  </div>
                  <div class="row input-row">
                    <shop-input>
                      ...
                      <shop-md-decorator error-message="Invalid Card Number" aria-hidden="true">
                        <label for="ccNumber">Número de la tarjeta</label>
                        <shop-underline></shop-underline>
                      </shop-md-decorator>
                    </shop-input>
                  </div>
                  <div class="row input-row">
                    <div class="column">
                      <label for="ccExpMonth">Expira</label>
                      <shop-select>
                  ...
                  <shop-button responsive id="submitBox">
                    <input type="button" on-click="_submit" value="Colocar Orden">
                  </shop-button>
                </section>
              </div>
            </form>
        ...
        <!-- Error message UI -->
        <header state="error">
          <h1>No se pudo realizar la transacción</h1>
          <p id="errorMessage">[[response.errorMessage]]</p>
          <shop-button responsive>
            <a href="/checkout">Intente nuevamente</a>
          </shop-button>
        </header>
